...
u16 ALIGN4 AzaleaBallMart[][24] = 
{
	{ITEM_HONEY, ITEM_FOCUS_SASH, ITEM_NET_BALL, ITEM_DIVE_BALL, ITEM_NEST_BALL, ITEM_REPEAT_BALL, ITEM_TIMER_BALL, ITEM_LUXURY_BALL, ITEM_PREMIER_BALL, ITEM_DUSK_BALL, ITEM_QUICK_BALL, ITEM_CHERISH_BALL, ITEM_FAST_BALL, ITEM_LEVEL_BALL, ITEM_LURE_BALL, ITEM_HEAVY_BALL, ITEM_LOVE_BALL, ITEM_FRIEND_BALL, ITEM_MOON_BALL, 0xFFFF}, //entry 0 - Azalea Ball Mart
};
    ...
    switch (sw) {
		...
		case SCRIPT_OLIVINE_MARTS:;
			*(u32 *)(0x0210FA3C) = (u32)OlivineMarts[arg0];
			break;
		case SCRIPT_BALL_MART:;
			*(u32 *)(0x0210FA3C) = (u32)AzaleaBallMart[arg0];
			break;
