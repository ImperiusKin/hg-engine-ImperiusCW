...
OVERWORLDS_NPC_SRCS := $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/npc/*.png) $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/npc/*.json) $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/npc/*.pal)
OVERWORLDS_NPC_OBJS := $(patsubst $(OVERWORLDS_DEPENDENCIES_DIR)/npc/%.png,$(OVERWORLDS_DIR)/2_%.btx0,$(OVERWORLDS_NPC_SRCS))

# add your own overworld sources here
ALL_OVERWORLDS_SRCS := $(OVERWORLDS_SRCS) $(OVERWORLDS_NPC_SRCS)
ALL_OVERWORLDS_OBJS := $(OVERWORLDS_OBJS) $(OVERWORLDS_NPC_OBJS)
...
$(OVERWORLDS_DIR)/2_%.btx0:$(OVERWORLDS_DEPENDENCIES_DIR)/npc/%.png $(OVERWORLDS_DEPENDENCIES_DIR)/npc/%.json $(OVERWORLDS_DEPENDENCIES_DIR)/npc/%*.pal
	$(BTX) $< $@
